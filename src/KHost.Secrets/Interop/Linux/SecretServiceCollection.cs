...
//     src/Core/Interop/Linux/SecretServiceCollection.cs  @ 838e3496
//
...
//
// Changed from upstream: nullable disabled (upstream is unannotated), namespace; platform guard inlined.
...
using System.Text;
using static KHost.Secrets.Interop.Linux.Native.Gobject;
using static KHost.Secrets.Interop.Linux.Native.Glib;
using static KHost.Secrets.Interop.Linux.Native.Libsecret;
using static KHost.Secrets.Interop.Linux.Native.Libsecret.SecretSchemaAttributeType;
using static KHost.Secrets.Interop.Linux.Native.Libsecret.SecretSchemaFlags;

namespace KHost.Secrets.Interop.Linux
{
    public class SecretServiceCollection : ICredentialStore
    {
        private const string SchemaName = "com.microsoft.KHost.Secrets";
        ...
        {
            if (!OperatingSystem.IsLinux()) throw new PlatformNotSupportedException("This store is Linux only.");
