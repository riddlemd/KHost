...
public sealed class AppSettings
{
    ...
    /// </summary>
    public double AdDefaultLengthSeconds { get; set; } = DefaultAdLengthSeconds;
    ...
    public const double DefaultAdLengthSeconds = 10;
    ...
    public const double MinAdLengthSeconds = 1;
    public const double MaxAdLengthSeconds = 300;
