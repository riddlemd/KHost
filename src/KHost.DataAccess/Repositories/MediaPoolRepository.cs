    ...
    public async Task ReplaceEntriesAsync(Guid poolId, IReadOnlyList<MediaPoolEntry> entries)
    {
        ...
        for (var i = 0; i < entries.Count; i++)
        {
            ...
            context.MediaPoolEntries.Add(new MediaPoolEntry
            {
                ...
                // An ad is picture and sound together, so these travel with the line. A new column
                // needs adding here as well as to the model, and nothing complains if it is missed.
