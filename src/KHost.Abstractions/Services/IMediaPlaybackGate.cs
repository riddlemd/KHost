...
/// (Example renders a track from a paid account's .kit and does not want it played once that
...
public interface IMediaPlaybackGate
{
    ...
    /// <summary>
    /// The plugin's identifier (its assembly name, e.g. <c>KHost.Plugins.Example</c>), matched
