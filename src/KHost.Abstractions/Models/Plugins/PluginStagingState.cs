...
{
    /// <summary>Nothing staged: no pending installs, removals, or failures.</summary>
    ...
    /// <summary>True when nothing is staged: no pending installs, removals, or failures.</summary>
