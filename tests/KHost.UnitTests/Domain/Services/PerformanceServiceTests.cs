...
public class PerformanceServiceTests
{
    ...
    {
        var mediaId = ArrangeGatedMedia(new PlaybackGateResult(false, "Sign in to KaraFun."));
        var singerId = Guid.NewGuid();
    ...
    public async Task CreateAndEnqueueAsync_MediaItsProviderRefuses_FlashesTheProvidersReason()
    {
        ...
        flash.Received(1).Show("Sign in to KaraFun.", FlashType.Warning);
    }
    ...
    /// <summary>The gate is asked about the queue, not the play: KaraFun answers a queue by asking
