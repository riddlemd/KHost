...
public class PreparedMediaServiceTests
{
    ...
    {
        await using var queued = new QueuedKit(verdict: new PlaybackGateResult(false, "Sign in to KaraFun."));
    ...
    /// Passing the wrong moment asks a question whose answer is about something else: KaraFun
