...
public class ConfirmDuplicateSongHandlerTests
{
    private static ConfirmDuplicateSongRequest MakeRequest()
        => new("Song", 1, null);
    ...
    public async Task HandleAsync_CancelledAfterRequestIsShown_CompletesAsCancelled()
    {
        ...
        var handler = new ConfirmDuplicateSongHandler(dialogService);
