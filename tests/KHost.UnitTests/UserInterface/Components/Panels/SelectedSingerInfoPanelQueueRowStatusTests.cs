...
public class SelectedSingerInfoPanelQueueRowStatusTests : BunitContext
{
    ...
    /// <summary>The status column says what the library row says, and nothing else.</summary>
    [Theory]
    [InlineData(MediaStatus.Ready, "Ready")]
    ...
    public void AQueueRow_ShowsItsMediaStatus(MediaStatus status, string expected)
    {
